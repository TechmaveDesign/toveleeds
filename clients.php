...
<div class="content">
	...
	<!-- /Breadcrumb -->
									...
									<div class="custom-datatable-filter">
										<table class="table common-datatable withoutActionTR nowrap w-100">
											...
											<tbody>
												<tr>
													<td>
														<a href="client-detail.php" class="hightlightKOPID">#CL001</a>
													</td>
													<td>
												...
												<tr>
							<td><a href="client-detail.php" class="hightlightKOPID">#CL002</a></td>
							<td>
								<div class="d-flex align-items-center file-name-icon">
									<a href="#" class="avatar avatar-md avatar-rounded">
						...
						<tr>
							<td><a href="client-detail.php" class="hightlightKOPID">#CL003</a></td>
							<td>
								<div class="d-flex align-items-center file-name-icon">
									<a href="#" class="avatar avatar-md avatar-rounded">
						...
						<tr>
							<td><a href="client-detail.php" class="hightlightKOPID">#CL004</a></td>
							<td>
								<div class="d-flex align-items-center file-name-icon">
									<a href="#" class="avatar avatar-md avatar-rounded">
