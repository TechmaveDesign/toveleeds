...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
        <div class="my-auto mb-2">
            <h2 class="mb-1">All Equipment Inspections</h2>
            <nav>
            ...
            <div class="tab-pane show active text-muted" id="nav-newjobs" role="tabpanel">
                ...
                <div id="tablefiltesa_container">
                                ...
                                <div class="leftprFilters">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
                                        ...
                                        <div class="col-lg-3 col-sm-6 col-12">
                                            <div class="input-blocks">
                                                <!-- <i data-feather="box" class="info-img"></i> -->
                                                <iconify-icon icon="fluent:form-48-regular" class="info-img"></iconify-icon>
                                                <select class="select2">
                                                    <option disabled selected>DLS Type</option>
                                                    <option>DLS1</option>
                                                    <option>DLS2</option>
                                                    <option>DLS3</option>
                                                    <option>DLS4</option>
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <td><a href="job-order-details-inspection-assessment.php" class="hightlightKOP blueColor">#JO2500002</a></td>
                        <td>John Doe</td>
                        <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500002</a></td>
                        <td>Hydraulic Pump</td>
                        <td>28 Jan, 2025 02:30 PM</td>
                        <td>DLS2</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500001</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">CL2500001</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        ...
                        <td>
                            <div class="d-flex align-items-center ActionDropdown">
                                <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip" data-placement="top" title="View Job Orders" href="inspection-edit-rd1-form.php">
                                    <span class="icon">
                    ...
                    <tr>
                        ...
                        <td><a href="job-order-details-inspection-assessment.php" class="hightlightKOP partialPaid">#JO2500002</a></td>
                        <td>John Doe</td>
                        <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500003</a></td>
                        <td>Generator</td>
                        <td>29 Jan, 2025 09:15 AM</td>
                        <td>DLS3</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500002</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">CL2500002</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="job-order-details-inspection-assessment.php" class="hightlightKOP ">#JO2500002</a></td>
                        <td>John Doe</td>
                        <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500004</a></td>
                        <td>Cooling Tower</td>
                        <td>30 Jan, 2025 03:45 PM</td>
                        <td>DLS4</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500003</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">CL2500003</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td>--</td>
                        <td>L.Stk2500003</td>
                        <td><span class="badge badge-soft-warning">In Progress</span></td>
                    ...
                    <tr>
                        ...
                        <td><a href="job-order-details-inspection-assessment.php" class="hightlightKOP ">#JO2500003</a></td>
                        <td>Michael william</td>
                        <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500005</a></td>
                        <td>Cooling Tower</td>
                        <td>30 Jan, 2025 03:45 PM</td>
                        <td>DLS4</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500005</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">CL2500005</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        <td>--</td>
                        <td>L.Stk2500005</td>
                        <td><span class="badge badge-soft-warning">In Progress</span></td>
            ...
            <div class="custom-datatable-filter">
                <div id="tablefiltesa_container">
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <td><a href="renewal-jobs.php" class="hightlightKOP blueColor">#JO2500007</a></td>
                        <td>John Doe</td>
                        <td><a href="equipment-inspection-renewal-dls.php" class="hightlightKOPID">#DLS2500005</a></td>
                        <td>Hydraulic Pump</td>
                        <td>28 Jan, 2025 02:30 PM</td>
                        <td>DLS2</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500005</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="renewal-jobs.php" class="hightlightKOP partialPaid">#JO2500007</a></td>
                        <td>John Doe</td>
                        <td><a href="equipment-inspection-renewal-dls.php" class="hightlightKOPID">#DLS2500003</a></td>
                        <td>Generator</td>
                        <td>29 Jan, 2025 09:15 AM</td>
                        <td>DLS3</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500002</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="renewal-jobs.php" class="hightlightKOP ">#JO2500007</a></td>
                        <td>John Doe</td>
                        <td><a href="equipment-inspection-renewal-dls.php" class="hightlightKOPID">#DLS2500004</a></td>
                        <td>Cooling Tower</td>
                        <td>30 Jan, 2025 03:45 PM</td>
                        <td>DLS4</td>
                        <td><a href="#" class="hightlightKOP">#Cert2500003</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                    ...
                    <tr>
                        ...
                        <td><a href="renewal-jobs.php" class="hightlightKOP ">#JO2500008</a></td>
                        <td>Michael william</td>
                        <td><a href="equipment-inspection-renewal-dls.php" class="hightlightKOPID">#DLS2500005</a></td>
                        <td>Cooling Tower</td>
                        <td>30 Jan, 2025 03:45 PM</td>
                ...
                <div id="tablefiltesa_container">
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500005</a></td>
                            <td>Boiler System</td>
                            <td>25 Jan, 2025 10:00 AM</td>
                            <td>DLS5</td>
                            <td><a href="#" class="hightlightKOP">#Cert2500004</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td><a href="#" class="hightlightKOP">CL2500004</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td>--</td>
                            <td>L.Stk2500004</td>
                        ...
                        <tr>
                            ...
                            <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500006</a></td>
                            <td>Steam Turbine</td>
                            <td>22 Jan, 2025 01:30 PM</td>
                            <td>DLS6</td>
                            <td><a href="#" class="hightlightKOP">#Cert2500005</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td><a href="#" class="hightlightKOP">CL2500005</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                        ...
                        <tr>
                            ...
                            <td>Emma Wilson</td>
                            <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500007</a></td>
                            <td>Control Panel</td>
                            <td>20 Jan, 2025 05:00 PM</td>
                            <td>DLS7</td>
                            <td><a href="#" class="hightlightKOP">#Cert2500006</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td><a href="#" class="hightlightKOP">CL2500006</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                            <td>--</td>
                            <td>L.Stk2500006</td>
                            <td><span class="badge badge-soft-success">Completed</span></td>
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Michael Brown</td>
                                <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500008</a></td>
                                <td>Hydraulic Press</td>
                                <td>18 Jan, 2025 02:00 PM</td>
                                <td>DLS8</td>
                                <td><a href="#" class="hightlightKOP">#Cert2500007</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">CL2500007</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td>--</td>
                                <td>L.Stk2500007</td>
                            ...
                            <tr>
                                ...
                                <td>Sarah Miller</td>
                                <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500009</a></td>
                                <td>Cooling Tower</td>
                                <td>15 Jan, 2025 09:30 AM</td>
                                <td>DLS9</td>
                                <td><a href="#" class="hightlightKOP">#Cert2500008</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">CL2500008</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">RR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td>L.Stk2500008</td>
                                <td><span class="badge bg-outline-Draft pendingbadge badgecustomstyle"><span class="badge-label">Draft</span>
                            ...
                            <tr>
                                ...
                                <td><a href="job-order-details-inspection-assessment.php" class="hightlightKOP">#JO2500010</a></td>
                                <td>David Anderson</td>
                                <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500010</a></td>
                                <td>Crane System</td>
                                <td>12 Jan, 2025 03:45 PM</td>
                                <td>DLS10</td>
                                <td><a href="#" class="hightlightKOP">#Cert2500009</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">CL2500009</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td><a href="#" class="hightlightKOP">FIR</a><a href="#" class="DownLoadBtn"><iconify-icon icon="material-symbols:download"></iconify-icon></a></td>
                                <td>--</td>
                                <td>L.Stk2500009</td>
                                <td><span class="badge bg-outline-Draft pendingbadge badgecustomstyle"><span class="badge-label">Draft</span>
                ...
                <div id="tablefiltesa_container">
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <tr>
                            ...
                            <td><a href="job-order-details-inspection-assessment.php" class="hightlightKOP greenColor">#JO2500007</a></td>
                            <td>Emma Wilson</td>
                            <td><a href="inspection-edit-rd1-form.php" class="hightlightKOPID">#DLS2500007</a></td>
                            <td>Control Panel</td>
                            <td>20 Jan, 2025 05:00 PM</td>
...
document.addEventListener("DOMContentLoaded", function () {
    document.querySelector(".renewBtn").addEventListener("click", function (event) {
        ...
        Swal.fire({
            title: "Are you sure?",
            html: `Do you want to create the selected DLS numbers into one job?<br><strong>${dlsNumbers.join(", ")}</strong>`,
            icon: "warning",
