            ...
            <tbody>
                <tr>
                   <td>
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-detail-ndt.php">#JON2500001</a>  
                    </td>
                    <td>
                ...
                <tr> 
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-detail-ndt.php">#JON2500002</a>  
                    </td>
                    <td>
                        <div class="d-flex align-items-center file-name-icon">
                            <a href="client-detail.php" class="avatar avatar-md avatar-rounded">
                ...
                <td>
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-detail-ndt.php">#JON2500003</a>  
                    </td>
                    <td>
                        <div class="d-flex align-items-center file-name-icon">
                            <a href="client-detail.php" class="avatar avatar-md avatar-rounded">
            ...
            <tbody>
                <tr>
                  <td>
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-renewal-ndt.php">#JON2500001</a>  
                    </td>
                    <td>
                        <div class="d-flex align-items-center file-name-icon">
                            <a href="client-detail.php" class="avatar avatar-md avatar-rounded">
                    ...
                    <td>
                        <div class="d-flex align-items-center ActionDropdown">
                            <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                data-bs-toggle="tooltip" data-placement="top" title="Job Order Details"
                                href="job-order-renewal-ndt.php">
                                <span class="icon">
                                    <span class="feather-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                ...
                <tr>
                   <td>
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-renewal-ndt.php">#JON2500002</a>  
                    </td>
                    <td>
                        <div class="d-flex align-items-center file-name-icon">
                            <a href="client-detail.php" class="avatar avatar-md avatar-rounded">
                ...
                <tr>
                   <td>
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-renewal-ndt.php">#JON2500003</a>  
                    </td>
                    <td>
                        <div class="d-flex align-items-center file-name-icon">
                            <a href="client-detail.php" class="avatar avatar-md avatar-rounded">
        ...
        <table class="table common-datatable withoutActionTR nowrap w-100">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <td>
                        <a class="hightlightKOPID" href="job-order-detail-ndt.php">#JO2500005</a>  
                    </td>
                    <td>
                        <div class="d-flex align-items-center file-name-icon">
                            <a href="client-detail.php" class="avatar avatar-md avatar-rounded">
