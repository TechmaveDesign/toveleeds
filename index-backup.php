...
<div class="content">
	...
	<div class="d-md-flex d-block align-items-center justify-content-between mb-3">
		<div class="my-auto mb-2 dashtopTitle">
			...
			<p>Your hub for managing operations, tracking tasks, and monitoring performance.</p>
		</div>
		...
		<div class="card-body d-flex align-items-center justify-content-between flex-wrap pb-1">
			<div class="d-flex align-items-center mb-3">
				...
				<div class="ms-3">
					...
					<p>You have <span class="text-primary">21</span> Pending Approvals </p>
				</div>
			</div>
			<div class="d-flex align-items-center flex-wrap mb-1">
				<a href="#" class="btn btn-secondary btn-md me-2 mb-2" data-bs-toggle="modal"
					data-bs-target="#add_project"><i class="ti ti-square-rounded-plus me-1"></i>Add Clients</a>
				<a href="#" class="btn btn-primary btn-md mb-2" data-bs-toggle="modal" data-bs-target="#add_leaves"><i
						class="ti ti-square-rounded-plus me-1"></i>Add User</a>
			</div>
		</div>
	</div>
				...
				<div class="col-md-3 d-flex">
					<div class="card flex-fill">
						<div class="card-body">
							...
							<h6 class="fs-13 fw-medium text-default mb-1">Inspectors Overview</h6>
		...
		<div class="col-xxl-4 d-flex">
			<div class="card flex-fill">
				...
				<div class="card-body">
					...
					<p class="fs-13"><i class="ti ti-circle-filled me-2 fs-8 text-primary"></i> No of Tasks
					...
					<div class="row g-2 justify-content-center mb-3">
						<div class="col-md col-sm-3 col-6">
							<div class="border rounded p-2">
								<p class="mb-1"><i class="ti ti-point-filled text-primary"></i>Total Inspections</p>
								<h6>50000</h6>
							</div>
						</div>
						<div class="col-md col-sm-3 col-6">
							<div class="border rounded p-2">
								<p class="mb-1"><i class="ti ti-point-filled text-primary"></i>Pending Inspections
								</p>
								<h6>25985</h6>
							</div>
						</div>
						<div class="col-md col-sm-3 col-6">
							<div class="border rounded p-2">
								<p class="mb-1"><i class="ti ti-point-filled text-primary"></i>Job Assigned
								</p>
								<h6>12566</h6>
							</div>
						</div>
						<div class="col-md col-sm-3 col-6">
							<div class="border rounded p-2">
								<p class="mb-1"><i class="ti ti-point-filled text-primary"></i>Job Orders Closed</p>
								<h6>8965</h6>
							</div>
						</div>
