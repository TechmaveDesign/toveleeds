            ...
            <div class="main-header">
                ...
                <div class="header-left">
                    <a href="index.php" class="logo">
                        <img src="assets/img/newimages/toveleadslogo-white.png" alt="Logo">
                    </a>
                    <a href="index.php" class="dark-logo">
                        <img src="assets/img/newimages/logo.png" alt="Logo">
                    </a>
                </div>
                ...
                <div class="header-user">
                    <div class="nav user-menu nav-list">
                        ...
                        <div class="me-auto d-flex align-items-center" id="header-search">
                            ...
                            <a id="backtotemplate" href="all-templates.php" class="btn btn-menubar me-1">
                                <i class="ti ti-arrow-bar-to-left"></i>
                            </a>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <a href="##"
                                                        ...
                                                        <span class="d-flex align-items-center me-3">
                                                            <i class="ti ti-user-shield text-default me-2"></i>Clients
                                                        </span>
                                                    ...
                                                    <a href="##"
                                                        ...
                                                        <span class="d-flex align-items-center me-3">
                                                            <i
                                                                class="ti ti-heart-handshake text-default me-2"></i>Inspectors
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                    <a href="##"
                                                        ...
                                                        <span class="d-flex align-items-center me-3">
                                                            <i
                                                                class="ti ti-timeline-event-text text-default me-2"></i>Trainers
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                </div>
                                                <div class="col-sm-6">
                                                    <a href="##"
                                                        class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
                                                        <span class="d-flex align-items-center me-3">
                                                            <i class="ti ti-building text-default me-2"></i>Supervisors
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                    <a href="##"
                                                        class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
                                                        <span class="d-flex align-items-center me-3">
                                                            <i class="ti ti-user-check text-default me-2"></i>Job Orders
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                    <a href="##"
                                                        class="d-flex align-items-center justify-content-between p-2 crm-link mb-3">
                                                        <span class="d-flex align-items-center me-3">
                                                            <i class="ti ti-activity text-default me-2"></i>All Report
                                                        </span>
                                                        <i class="ti ti-arrow-right"></i>
                                                    </a>
                                                </div>
                                ...
                                <div class="dropdown-menu shadow-none">
                                    <div class="card mb-0">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="fs-12 fw-medium mb-0"><a
                                                            ...
                                                            class="__cf_email__"
                                                            data-cfemail="0d7a6c7f7f68634d68756c607d6168236e6260">[email&#160;protected]</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer py-1">
                                            <a class="dropdown-item d-inline-flex align-items-center p-0 py-2"
                                                href="##"><i class="ti ti-login me-2"></i>Logout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-logo">
                ...
                <a href="index.php" class="logo-small">
                    <img src="assets/img/newimages/logoicon.png" alt="Logo">
                </a>
                <a href="index.php" class="dark-logo">
                    <img src="assets/img/newimages/logo.png" alt="Logo">
                </a>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    ...
                    <div class="tab-column collapse-view">
                        <div class="plan-based-nav-dark py-1 plan-based-com ">
                            <div class="px-3 pb-2">
                                <div class="ps-3 rounded-sm" style="border-left:3px solid  #ffda84">Secure your session by logging out below. </div>
                            </div>
