                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center ActionDropdown">
                                        ...
                                        <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                            data-bs-toggle="offcanvas" data-bs-target="#Editjoborder" aria-controls="offcanvasRight"
                                            href="#">
                                            <span class="icon">
                                                <span class="feather-icon">
...
<!-- Job order create Edit Start-->
<?php include("create-edit-job-order.php") ?>
<!-- Job order create Edit End-->
