...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Inspection DLS 10 Form View</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Inspection DLS 10 Form</li>
                </ol>
            </nav>
        </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="InspectionFormsContainer">
                                        <div class="row">
                                            ...
                                            <div class="card-header cardHeaderAss mt-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Maximum Rated Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Boom Length</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Present Main Hoist Max. Rated Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Auxiliary Hoist Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Super Lift Mast Length</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Single line Pull Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Main Hock Block Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Main Hoist Wire Rope Diameter</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Auxiliary Hoist Wire Rope Diameter</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Counterweight</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                           <input type="text" class="form-control">
                                                        </div>
