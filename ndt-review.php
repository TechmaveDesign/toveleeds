...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
        <div class="my-auto mb-2">
            <h2 class="mb-1">All NDT Review</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All NDT Review</li>
                </ol>
            </nav>
        </div>
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <tr>
                           <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500001</a></td>
                            <td>Air Compressor</td>
                            <td>27 Jan, 2025 11:00 AM</td>
                            <td><a href="#" class="hightlightKOP">#Rept2500001</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><a href="#" class="hightlightKOP">#FDLS2500001</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><a href="#" class="hightlightKOP">#WQT2500000</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><span class="badge badge-soft-warning">In Progress</span></td> <!-- Updated Status -->
                            <td>
                                <div class="d-flex align-items-center ActionDropdown">
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip"
                                        data-placement="top" title="View Job Orders" href="air-in-filtration-test.php">
                                        <span class="icon">
                        ...
                        <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500002</a></td>
                            <td>Hydraulic Pump</td>
                            <td>28 Jan, 2025 02:30 PM</td>
                            <td><a href="#" class="hightlightKOP">#Rept2500002</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><a href="#" class="hightlightKOP">#FDLS2500002</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><a href="#" class="hightlightKOP">#WQT2500001</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><span class="badge badge-soft-warning">In Progress</span></td> <!-- Updated Status -->
                            <td>
                                <div class="d-flex align-items-center ActionDropdown">
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip"
                                        data-placement="top" title="View Job Orders" href="#">
                                        <span class="icon">
                                            <span class="feather-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500003</a></td>
                            <td>Generator</td>
                            <td>29 Jan, 2025 09:45 AM</td>
                            <td><a href="#" class="hightlightKOP">#Rept2500003</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><a href="#" class="hightlightKOP">#FDLS2500003</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><a href="#" class="hightlightKOP">#WQT2500002</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                                </a></td>
                            <td><span class="badge badge-soft-warning">In Progress</span></td> <!-- Updated Status -->
                            <td>
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <tr>
                           <td>
                            ...
                            <td><a href="job-order-renewal-ndt.php" class="hightlightKOP">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test-dls-renewal.php" class="hightlightKOPID">#DS2500001</a></td>
                            <td>Air Compressor</td>
                            <td>27 Jan, 2025 11:00 AM</td>
                            <td><a href="#" class="hightlightKOP">#Rept2500001</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                            ...
                            <td><span class="badge badge-soft-warning">Renewal Pending</span></td> <!-- Updated Status -->
                            <td>
                                <div class="d-flex align-items-center ActionDropdown">
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover" data-bs-toggle="tooltip"
                                        data-placement="top" title="View Job Orders" href="job-order-renewal-ndt.php">
                                        <span class="icon">
                                            <span class="feather-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <td>
                            ...
                            <td><a href="job-order-renewal-ndt.php" class="hightlightKOP">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test-dls-renewal.php" class="hightlightKOPID">#DS2500002</a></td>
                            <td>Hydraulic Pump</td>
                            <td>28 Jan, 2025 02:30 PM</td>
                            <td><a href="#" class="hightlightKOP">#Rept2500002</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                        ...
                        <td>
                            ...
                            <td><a href="job-order-renewal-ndt.php" class="hightlightKOP">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test-dls-renewal.php" class="hightlightKOPID">#DS2500003</a></td>
                            <td>Generator</td>
                            <td>29 Jan, 2025 09:45 AM</td>
                            <td><a href="#" class="hightlightKOP">#Rept2500003</a><a href="#" class="DownLoadBtn">
                                    <iconify-icon icon="material-symbols:download"></iconify-icon>
                ...
                <div id="tablefiltesa_container">
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP">#JON2500002</a></td>
                        ...
                        <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP">#JON2500003</a></td>
                            <td>Emma Davis</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500003</a></td>
                            <td>Generator</td>
                            <td>29 Jan, 2025 09:45 AM</td>
                    ...
                    <table class="table common-datatable withoutActionTR nowrap w-100">
                        ...
                        <tr>
                           <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP greenColor">#JON2500001</a></td>
                            <td>John Smith</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500001</a></td>
                            <td>Air Compressor</td>
                            <td>27 Jan, 2025 11:00 AM</td>
                        ...
                        <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP greenColor">#JON2500002</a></td>
                            <td>Michael Johnson</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500002</a></td>
                            <td>Hydraulic Pump</td>
                            <td>28 Jan, 2025 02:30 PM</td>
                        ...
                        <td>
                            ...
                            <td><a href="job-order-detail-ndt.php" class="hightlightKOP greenColor">#JON2500003</a></td>
                            <td>Emma Davis</td>
                            <td><a href="air-in-filtration-test.php" class="hightlightKOPID">#DS2500003</a></td>
                            <td>Generator</td>
                            <td>29 Jan, 2025 09:45 AM</td>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "job-order-renewal-ndt.php" + newJobOrderID;
                });
