...
!function (n) {
      ...
      if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
        ...
        var u = B.extend(!0, {}, $.models.oSettings, {
          ...
          error: function error() {
            ...
            p = Ce(u, h[0]);
        if (n.aoColumns) f = n.aoColumns;else if (p.length) for (l = p[a = 0].length; a < l; a++) {
          f.push(null);
        }
        ...
        if (T) for (g = T.length - 1; 0 <= g; g--) {
          ...
          for (Array.isArray(I) || (I = [I]), v = 0, b = I.length; v < b; v++) {
            ...
            if ("number" == typeof A && 0 <= A) {
              ...
              _(A, x);
            } else if ("number" == typeof A && A < 0) _(C.length + A, x);else if ("string" == typeof A) for (y = 0, D = C.length; y < D; y++) {
        ...
        var F,
          ...
          if (0 === t.length && (t = B("<tfoot/>").appendTo(o)), u.nTFoot = t[0], B("tr", t).addClass(c.tfoot.row), n.aaData) for (a = 0; a < n.aaData.length; a++) {
            Y(u, n.aaData[a]);
      ...
      return B.isPlainObject(a) ? $.util.set(a._) : null === a ? function () {} : "function" == typeof a ? function (e, t, n) {
        ...
        for (var a, r, o, i, l = de(n), n = l[l.length - 1], s = 0, u = l.length - 1; s < u; s++) {
          ...
          if (a = l[s].match(ce), r = l[s].match(p), a) {
            if (l[s] = l[s].replace(ce, ""), e[l[s]] = [], (a = l.slice()).splice(0, s + 1), i = a.join("."), Array.isArray(t)) for (var c = 0, d = t.length; c < d; c++) {
              _f(o = {}, t[c], i), e[l[s]].push(o);
            } else e[l[s]] = t;
            return;
          }
      ...
      return B.isPlainObject(r) ? (o = {}, B.each(r, function (e, t) {
        ...
        if ("" !== n) for (var i = de(n), l = 0, s = i.length; l < s; l++) {
          if (d = i[l].match(ce), a = i[l].match(p), d) {
            if (i[l] = i[l].replace(ce, ""), "" !== i[l] && (e = e[i[l]]), r = [], i.splice(0, l + 1), o = i.join("."), Array.isArray(e)) for (var u = 0, c = e.length; u < c; u++) {
              r.push(_f2(e[u], t, o));
            }
  ...
  function H(e) {
    var t = e.aoHeader,
        n = e.aoColumns,
        a = 0;
    if (t.length) for (var r = 0, o = t[0].length; r < o; r++) {
    ...
    for (var t, n, a, r, o, i, l, s = e.aoColumns, u = e.aoData, c = $.ext.type.detect, d = 0, f = s.length; d < f; d++) {
      ...
      if (h && !o._render) {
        ...
        for (var p, g = e, m = d, v = g.aoData, b = 0; b < v.length; b++) {
          v[b].nTr && (p = G(g, b, m, "display"), v[b].displayData[m] = p, ue(v[b].anCells[m], p));
        }
      }
    }
  }
  ...
  function Y(e, t, n, a) {
    for (var r = e.aoData.length, o = B.extend(!0, {}, $.models.oRow, {
      src: n ? "dom" : "data",
      idx: r
    }), i = (o._aData = t, e.aoData.push(o), e.aoColumns), l = 0, s = i.length; l < s; l++) {
      i[l].sType = null;
    }
  ...
  function pe(e, t, n, a) {
    ...
    if (i._aSortData = null, i._aFilterData = null, i.displayData = null, "dom" !== n && (n && "auto" !== n || "dom" !== i.src)) {
      var l = i.anCells,
          s = me(e, t);
      if (l) if (void 0 !== a) ue(l[a], s[a]);else for (r = 0, o = l.length; r < o; r++) {
        ue(l[r], s[r]);
      }
  ...
  function ge(e, t, n, a) {
    ...
    } else for (var p = 0, g = (u = t.anCells).length; p < g; p++) {
      o(u[p]);
    }
  ...
  function ye(e, t) {
    ...
    if (o) {
      if (("header" === t || f(e.aoColumns, i).join("")) && 1 === (n = (n = B("tr", o)).length ? n : B("<tr/>").appendTo(o)).length) for (var l = B("td, th", n).length, s = r.length; l < s; l++) {
  ...
  function xe(e, t) {
    for (var n, a, r = De(e, t), o = 0; o < t.length; o++) {
      if (n = t[o].row) for (; a = n.firstChild;) {
        n.removeChild(a);
      }
  ...
  function Te(e, t, n) {
    for (var i = {}, a = (B.each(t, function (e, t) {
      if (null !== t) {
        ...
        if (a[n] && a[n].contents || (a[n] = {
          contents: []
        }), Array.isArray(t)) for (var o = 0; o < t.length; o++) {
          r(a[n].contents, t[o]);
    ...
    }), "bottom" === n && a.reverse(), []), o = 0, l = a.length; o < l; o++) {
      a[o].val.full && (r.push({
        full: a[o].val.full
  ...
  function we(o, i) {
    ...
    B.each(i, function (e) {
      for (var t, n = i[e].contents, a = 0, r = n.length; a < r; a++) {
        n[a] && ("string" == typeof n[a] ? n[a] = l(n[a], null) : B.isPlainObject(n[a]) ? n[a] = l(n[a].feature, n[a].opts) : "function" == typeof n[a].node ? n[a] = n[a].node(o) : "function" == typeof n[a] && (t = n[a](o), n[a] = "function" == typeof t.node ? t.node() : t));
      }
    });
  }
  ...
  function _e(t) {
    ...
    if (t.nTableWrapper = r[0], t.sDom) for (var o, i, l, s, u, c, d = t, e = t.sDom, f = r, h = e.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++) {
      o = null, "<" == (i = h[p]) ? (l = B("<div/>"), "'" != (s = h[p + 1])[0] && '"' != s[0] || (s = s.replace(/['"]/g, ""), u = "", -1 != s.indexOf(".") ? (c = s.split("."), u = c[0], c = c[1]) : "#" == s[0] ? u = s : c = s, l.attr("id", u.substring(1)).addClass(c), p++), f.append(l), f = l) : ">" == i ? f = f.parent() : "t" == i ? o = He(d) : $.ext.feature.forEach(function (e) {
      ...
      for (var a, r, o, i, l, s = n, u = s.aoColumns, c = s.aoData, d = 0; d < c.length; d++) {
        if (c[d] && !(l = c[d])._aFilterData) {
          for (o = [], a = 0, r = u.length; a < r; a++) {
            u[a].bSearchable ? "string" != typeof (i = null === (i = G(s, d, a, "filter")) ? "" : i) && i.toString && (i = i.toString()) : i = "", i.indexOf && -1 !== i.indexOf("&") && (Pe.innerHTML = i, i = Re ? Pe.textContent : Pe.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), o.push(i);
          }
  ...
  function qe(n, a, e) {
    ...
    if (B.isPlainObject(e)) t(e);else if (e.length && "number" == typeof e[0]) t(e);else if (e.length) for (var r = 0; r < e.length; r++) {
      t(e[r]);
    }
  }
  ...
  function Ue(e) {
    var t,
        ...
        f = B.isPlainObject(d),
        h = [];
    if (e.oFeatures.bSort) for (Array.isArray(d) && qe(e, h, d), f && d.pre && qe(e, h, d.pre), qe(e, h, e.aaSorting), f && d.post && qe(e, h, d.post), t = 0; t < h.length; t++) {
      if (c[l = h[t][0]]) for (n = 0, a = (r = c[l].aDataSort).length; n < a; n++) {
        i = c[o = r[n]].sType || "string", void 0 === h[t]._idx && (h[t]._idx = c[o].asSorting.indexOf(h[t][1])), h[t][1] && s.push({
          src: l,
          col: o,
          dir: h[t][1],
          index: h[t]._idx,
  ...
  function ze(e) {
    ...
    if (l.bSort && l.bSortClasses) {
      for (t = 0, n = r.length; t < n; t++) {
        a = r[t].src, B(f(e.aoData, "anCells", a)).removeClass(o + (t < 2 ? t + 1 : 3));
      }

      for (t = 0, n = i.length; t < n; t++) {
        a = i[t].src, B(f(e.aoData, "anCells", a)).addClass(o + (t < 2 ? t + 1 : 3));
      }
    }
  ...
  function Je(e, t, n) {
    ...
    for (r in t) {
      Object.prototype.hasOwnProperty.call(t, r) && (a = t[r], B.isPlainObject(a) ? (B.isPlainObject(e[r]) || (e[r] = {}), B.extend(!0, e[r], a)) : n && "data" !== r && "aaData" !== r && Array.isArray(a) ? e[r] = a.slice() : e[r] = a);
    }
  ...
  _U = function U(e, t) {
    ...
    var o = [];
    if (Array.isArray(e)) for (var a = 0, r = e.length; a < r; a++) {
      n(e[a]);
    } else n(e);
    ...
    iterator: function iterator(e, t, n, a) {
      ...
      for ("string" == typeof e && (a = n, n = t, t = e, e = !1), o = 0, i = h.length; o < i; o++) {
        var g = new _U(h[o]);
        if ("table" === t) void 0 !== (r = n.call(g, h[o], o)) && f.push(r);else if ("columns" === t || "rows" === t) void 0 !== (r = n.call(g, h[o], this[o], o)) && f.push(r);else if ("every" === t || "column" === t || "column-rows" === t || "row" === t || "cell" === t) for (c = this[o], "column-rows" === t && (u = dt(h[o], p.opts)), l = 0, s = c.length; l < s; l++) {
    ...
    if (n.length && t && (t instanceof _U || t.__dt_wrapper)) for (var a, r = 0, o = n.length; r < o; r++) {
    ...
    if (Array.isArray(e)) for (var n = 0, a = e.length; n < a; n++) {
      _U.register(e[n], _t2);
    } else for (var r = e.split("."), o = tt, i = 0, l = r.length; i < l; i++) {
      var s,
          u,
          c = function (e, t) {
  ...
  function rt(e, t, n, a, r) {
    for (var o, i, l, s, u = [], c = _typeof(t), d = 0, f = (t = t && "string" != c && "function" != c && void 0 !== t.length ? t : [t]).length; d < f; d++) {
    ...
    var h = C.selector[e];
    if (h.length) for (d = 0, f = h.length; d < f; d++) {
      u = h[d](a, r, u);
    }
    return x(u);
  }
  ...
  function lt(o, i, e, t) {
    function l(e, t) {
      var n;
      if (Array.isArray(e) || e instanceof B) for (var a = 0, r = e.length; a < r; a++) {
        l(e[a], t);
  ...
  var dt = function dt(e, t) {
    ...
    if ("current" == t) for (u = e._iDisplayStart, c = e.fnDisplayEnd(); u < c; u++) {
      a.push(r[u]);
    ...
    } else if ("index" == l || "original" == l) for (u = 0, c = e.aoData.length; u < c; u++) {
      e.aoData[u] && ("none" == i || -1 === (n = r.indexOf(u)) && "removed" == i || 0 <= n && "applied" == i) && a.push(u);
    } else if ("number" == typeof l) {
      var d = $e(e, l, "asc");
      if ("none" === i) a = d;else for (u = 0; u < d.length; u++) {
    ...
    var t = this,
      ...
      !function (e, t, n) {
        ...
        if (n) for (var s = f(o, "bVisible").indexOf(!0, t + 1), u = 0, c = l.length; u < c; u++) {
          l[u] && (r = l[u].nTr, a = l[u].anCells, r) && r.insertBefore(a[t], a[s] || null);
  ...
  return $.feature.register("pageLength", function (a, e) {
    ...
    var t = a.oClasses.length,
        ...
        o = [],
        i = [];
    if (Array.isArray(r[0])) o = r[0], i = r[1];else for (p = 0; p < r.length; p++) {
      B.isPlainObject(r[p]) ? (o.push(r[p].value), i.push(r[p].label)) : (o.push(r[p]), i.push(r[p]));
    }
