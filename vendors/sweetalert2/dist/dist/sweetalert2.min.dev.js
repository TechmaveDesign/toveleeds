...
*/
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Sweetalert2 = e();
}(void 0, function () {
  "use strict";
  ...
  var _t = function _t(t, e) {
    ...
    rt(t, e.icon && C[e.icon]), Ut(t, e), Nt(), et(t, e, "icon");
      ...
      Nt = function Nt() {
    var t = H();
    if (t) for (var e = window.getComputedStyle(t).getPropertyValue("background-color"), n = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), o = 0; o < n.length; o++) {
  ...
  function ze(t, e) {
    var n = H();
    if (n && t) if ("radio" === t.type) for (var o = n.querySelectorAll('[name="'.concat(w.radio, '"]')), i = 0; i < o.length; i++) {
      o[i].disabled = e;
    } else t.disabled = e;
  }
  ...
  var Yn = new WeakMap(),
    ...
    return u(e, [{
      ...
      value: function value(t) {
        ...
        if (function (t) {
          for (var e in !1 === t.backdrop && t.allowOutsideClick && E('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), t) {
