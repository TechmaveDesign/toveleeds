...
!function (l) {
  ...
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? (s = require("jquery"), c = function c(e, t) {
  ...
  function n(o) {
    ...
    t.on("mousedown.dtSelect", s, function (e) {
      ...
      var c,
          s = o.settings()[0],
          n = o.table().container();
      m(e.target).closest("div.dt-container")[0] == n && (n = o.cell(m(e.target).closest("td, th"))).any() && (c = m.Event("user-select.dt"), d(o, c, [l, n, e]), c.isDefaultPrevented() || (c = n.index(), "row" === l ? (t = c.row, h(e, o, s, "row", t)) : "column" === l ? (t = n.index().column, h(e, o, s, "column", t)) : "cell" === l && (t = n.index(), h(e, o, s, "cell", t)), s._select_lastCell = c));
    }), m("body").on("click.dtSelect" + v(o.table().node()), function (e) {
      var t;
      !l._select.blurable || m(e.target).parents().filter(o.table().container()).length || 0 === m(e.target).parents("html").length || m(e.target).parents("div.DTE").length || (t = m.Event("select-blur.dt"), d(o, t, [e.target, e]), t.isDefaultPrevented()) || f(l, !0);
    });
  }
  ...
  function a(s, e) {
    ...
    "api" !== s.select.style() && !1 !== s.select.info() && (o = s.rows({
      selected: !0
    }).flatten().length, t = s.columns({
      selected: !0
    }).flatten().length, l = s.cells({
      selected: !0
    }).flatten().length, c = function c(e, t, l) {
    ...
    o.columns(".dt-select").every(function () {
      ...
      m("input", e).length || (n = m("<input>").attr({
        ...
        "row" !== l && l || (l = o.rows({
          ...
          search: "applied"
        }).count(), s && s <= l && s === c ? n.prop("checked", !0).prop("indeterminate", !1) : 0 === s && 0 === l ? n.prop("checked", !1).prop("indeterminate", !1) : n.prop("checked", !1).prop("indeterminate", !0));
      }));
    });
  }
  ...
  function u(e, t, l, s) {
    ...
    e[t + "s"]({
      selected: !0
    }).any() || -1 !== s ? (o < s && (c = o, o = s, s = c), n.splice(o + 1, n.length), n.splice(0, s)) : n.splice(n.indexOf(l) + 1, n.length), e[t](l, {
      selected: !0
    }).any() ? (n.splice(n.indexOf(l), 1), e[t + "s"](n).deselect()) : e[t + "s"](n).select();
  }
  ...
  function h(e, t, l, s, c) {
    ...
    a && !o || ("os" === n ? e.ctrlKey || e.metaKey ? t[s](c).select(!a) : e.shiftKey ? "cell" === s ? r(t, c, l._select_lastCell || null) : u(t, s, c, l._select_lastCell ? l._select_lastCell[s] : null) : (o = t[s + "s"]({
      selected: !0
    }), a && 1 === o.flatten().length ? t[s](c).deselect() : (o.deselect(), t[s](c).select())) : "multi+shift" == n && e.shiftKey ? "cell" === s ? r(t, c, l._select_lastCell || null) : u(t, s, c, l._select_lastCell ? l._select_lastCell[s] : null) : t[s](c).select(!a));
  }
  ...
  _.select = {}, _.select.version = "2.0.0", _.select.init = function (c) {
    var e,
        t,
        l,
        s,
        ...
        f,
        h = c.settings()[0];
    if (!_.versionCheck("2")) throw "Warning: Select requires DataTables 2 or newer";
    h._select || (e = c.state.loaded(), t = function t(e, _t, l) {
      if (null !== l && void 0 !== l.select) {
        if (c.rows({
          selected: !0
        }).any() && c.rows().deselect(), void 0 !== l.select.rows && c.rows(l.select.rows).select(), c.columns({
          selected: !0
        }).any() && c.columns().deselect(), void 0 !== l.select.columns && c.columns(l.select.columns).select(), c.cells({
          selected: !0
        }).any() && c.cells().deselect(), void 0 !== l.select.cells) for (var s = 0; s < l.select.cells.length; s++) {
  ...
  t("select()", function () {
    ...
    return void 0 === l ? this.context[0]._select.style : this.iterator("table", function (e) {
      e._select || _.select.init(new _.Api(e)), e._select_init || (o = e, c = new _.Api(o), o._select_init = !0, o.aoRowCreatedCallback.push(function (e, t, l) {
        var s,
            c,
            n = o.aoData[l];
        ...
        m(c.rows({
          selected: !0
        }).nodes()).removeClass(c.settings()[0]._select.className), s(c), c.off(".dtSelect"), m("body").off(".dtSelect" + v(c.table().node()));
      })), e._select.style = l;
      var o,
          c,
          t = new _.Api(e);
    ...
    return void 0 === t ? this.context[0]._select.selector : this.iterator("table", function (e) {
      s(new _.Api(e)), e._select.selector = t, "api" !== e._select.style && n(new _.Api(e));
    });
    ...
    return !1 === e ? this.deselect() : (this.iterator("row", function (e, t) {
      ...
      for (var c = 0; c < s.length; c++) {
        "select-checkbox" === s[c].sType && (m("input.dt-select-checkbox", l.anCells[c]).prop("checked", !0), l._aSortData[c] = null);
      }
    ...
    return this.iterator("row", function (e, t) {
      ...
      for (var c = 0; c < s.length; c++) {
        "select-checkbox" === s[c].sType && (m("input.dt-select-checkbox", l.anCells[c]).prop("checked", !1), l._aSortData[c] = null);
      }
    }), this.iterator("table", function (e, t) {
  ...
  return m.extend(_.ext.buttons, {
    selected: {
      ...
      init: function init(l, e, s) {
        var c = this;
        s._eventNamespace = ".select" + b++, l.on(w(s), function () {
          var e, t;
          c.enable((e = l, !(-1 === (t = s).limitTo.indexOf("rows") || !e.rows({
            selected: !0
      ...
      destroy: function destroy(e, t, l) {
    ...
    selectedSingle: {
      ...
      init: function init(t, e, l) {
        var s = this;
        l._eventNamespace = ".select" + b++, t.on(w(l), function () {
          var e = t.rows({
            selected: !0
    ...
    selectAll: {
      ...
      action: function action(e, t, l, s) {
