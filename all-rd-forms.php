...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
        <div class="my-auto mb-2">
            <h2 class="mb-1">All DLS Forms</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All DLS Forms</li>
                </ol>
            </nav>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="LongMesage_container">
                                ...
                                <a href="#" class="AddEditBtnRemark" data-bs-toggle="modal" data-bs-target="#addRemark"><iconify-icon icon="material-symbols:add-2-rounded"></iconify-icon></a>
                            </div>
                        </td>
                        <td>CER1</td>
                        <td>Checklist 1</td>
...
<div class="modal fade custombottm_modalStyle" id="addRemark">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                                ...
                                <textarea type="text" placeholder="Enter here..." class="form-control"></textarea>
                            </div>
...
<div class="modal fade custombottm_modalStyle" id="EditRemark">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                        <div class="form-group">
                                <label class="form-label">Edit Remark</label>
                                <textarea type="text" placeholder="Enter here..." class="form-control"></textarea>
                            </div>
