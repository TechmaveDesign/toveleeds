...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Update Job Order</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Job Order</li>
                </ol>
            </nav>
        </div>
                  ...
                  <div class="NDTSelectOptions">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="col-lg-12 mb-3">
                            <h6 class="paymentHistory">Payment History Activity</h6>
