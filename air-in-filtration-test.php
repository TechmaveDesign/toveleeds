...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
        <div class="my-auto mb-2">
            <h2 class="mb-1">NDT - Air In Filtration Test</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Air In Filtration Test</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="mb-2 d-flex gap-2">
               <a href="job-order-detail-ndt.php" 
     ...
     <div class="CheckListMainContainer">
        ...
        <div class="checklistSubContainer">
            ...
            <div class="FormSubmit_fix_container">
                    <a href="job-order-detail-ndt.php" class="SaveDataBtn">
