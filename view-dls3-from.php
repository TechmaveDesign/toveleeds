...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Inspection DLS 3 Form View</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Inspection DLS 3 Form</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Present Configuration
                                                                Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Equipment Asset No.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Hook No.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Hook Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Wire Rope Dia.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="strike-info QuestionTitle_wrap">
                                                                                <h4
                                                                                    ...
                                                                                    <div
                                                                                        class="js-overflow-line-wrapper questionCount">
                                                                                        Q4.</div>Inspect for visible
                                                                                    damages, dents, or cracks
                                                                                </h4>
                                                                                <div class="insp_quest_ansChecklist">
                                                                                    <ul
                                                                                        class="checklist InspectionChecklistOpt">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="strike-info QuestionTitle_wrap">
                                                                                <h4
                                                                                    ...
                                                                                    <div
                                                                                        class="js-overflow-line-wrapper questionCount">
                                                                                        Q6.</div>Ensure all warning
                                                                                    labels and decals are legible
                                                                                </h4>
                                                                                <div class="insp_quest_ansChecklist">
                                                                                    <ul
                                                                                        class="checklist InspectionChecklistOpt">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="strike-info QuestionTitle_wrap">
                                                                                <h4
                                                                                    ...
                                                                                    <div
                                                                                        class="js-overflow-line-wrapper questionCount">
                                                                                        Q11.</div>Check for oil leaks
                                                                                    Inspect for unusual noises during
                                                                                    operation
                                                                                </h4>
                                                                                <div class="insp_quest_ansChecklist">
                                                                                    <ul
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="strike-info QuestionTitle_wrap">
                                                                                <h4
                                                                                    ...
                                                                                    <div
                                                                                        class="js-overflow-line-wrapper questionCount">
                                                                                        Q12.</div>Verify proper
                                                                                    alignment of compressor components
                                                                                </h4>
                                                                                <div class="insp_quest_ansChecklist">
                                                                                    <ul
                                                                                        class="checklist InspectionChecklistOpt">
