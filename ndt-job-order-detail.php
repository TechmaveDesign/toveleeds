...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb ">
        <div class="my-auto mb-2">
            <h2 class="mb-1">NDT Job Order Details</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="ndt-job-order-list.php">Job Orders</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">NDT Job Order Details</li>
                </ol>
            </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
        <div class="mb-2 d-flex gap-2">
               <a href="ndt-job-order-list.php" 
...
<div class="col-xl-6 middlereport_scroll">
    <div class="card">
        <div class="card-body pb-1">
            <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-4">
                <div>
                    <h4 class="mb-1">Air In Filtration Test (+2)</h4>
                ...
                <div class="col-sm-8">
                    <div class="d-flex align-items-center mb-3">
                        <div class="bg-gray-100 p-1 rounded d-flex align-items-center me-2">
                            ...
                            <h6 class="fs-12">Agricultural Tractor Operator</h6>
                        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5>Assign Data log Sheets</h5>
        </div>
        <div class="card-body">
            <ul class="OptListing NDTList">
                <li>
                    <div class="optProfile">
                        <img src="assets/img/newimages/ndtForm.png" alt="">
                    </div>
                    <div class="optDetail">
                        <div class="leftSideOpt">
                            <h6>Air In Filtration Test</h6>
                        ...
                        <div class="rightSideOpt">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                <a href="#" class="dropdown-item"><span><iconify-icon icon="material-symbols:download-rounded"></iconify-icon></span>Download FTR</a>
                            </div>
                            </div>
                        
                            <a href="air-in-filtration-test.php" class="viewDetailBtnOptHUO">
