...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Inspection DLS 7 Form View</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Inspection DLS 7 Form</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Manufacturer / Mfg. Year</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Length / Dia. / Width / Size</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">SWL / WLL </label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
