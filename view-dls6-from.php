...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Inspection DLS 6 Form View</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Inspection DLS 6 Form</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Sling Type</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Crane No.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card-header cardHeaderAss mt-4 mb-4">
                                    <h5>WLL verification</h5>
                                </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Mfg. Certificate</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="formSection relatedLoad_table">
                                            <div class="card-header cardHeaderAss">
                                    <h5>Rated Load / WLL (ton)</h5>
                                </div>

                                            <table class="table table-bordered text-center align-middle fieldsTable">
  <thead>
    ...
    <tr>
      ...
      <th rowspan="2">Wire Size Φ<br>(mm)</th>
      
      <th  class="img-cell">
        Single Leg<br>
        <img src="assets/img/newimages/dls6-image-1.png" alt="Single Leg">
      </th>
      <th colspan="2" class="img-cell">
        2 Leg<br>
        <img src="assets/img/newimages/dls6-image-2.png" alt="2 Leg">
      </th>
      <th colspan="2" class="img-cell">
        3 Leg &amp; 4 Leg<br>
        <img src="assets/img/newimages/dls6-image-3.png" alt="3 & 4 Leg">
      </th>
    </tr>

    <!-- Load factor angle labels -->
    <tr>
       <th></th>
      <th>0°&lt;β≤45°<br><span class="small-text">Load Factor 1.4</span></th>
      <th>45°&lt;β≤60°<br><span class="small-text">Load Factor 1.0</span></th>
      <th>0°&lt;β≤45°<br><span class="small-text">Load Factor 2.1</span></th>
      <th>45°&lt;β≤60°<br><span class="small-text">Load Factor 1.5</span></th>
    </tr>
  </thead>
  <tbody>
    <tr>
