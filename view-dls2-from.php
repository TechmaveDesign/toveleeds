...
<div class="content">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb">
        <div class="my-auto mb-2">
            <h2 class="mb-1">Inspection DLS 2 Form View</h2>
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Inspection DLS 2 Form</li>
                </ol>
            </nav>
        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Max. Rated Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Main Rope Dia.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Main Hook No.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Main Hook Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Auxiliary Rope Dia.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Auxiliary Hook No.</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label class="form-label">Auxiliary Hook Capacity</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" class="form-control">
                                                        </div>
                                                            ...
                                                            <div class="strike-info QuestionTitle_wrap">
                                                                ...
                                                                <div class="insp_quest_ansChecklist">
                                                                    <ul class="checklist InspectionChecklistOpt">
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" name="checklist1" hidden="" checked="" disabled="" data-original-disabled="true">
                                                                               Yes
                                                                        ...
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" name="checklist1" hidden="" disabled="" data-original-disabled="true">
                                                                               No
                                                                                <iconify-icon icon="gg:check-o" class="check-icon"></iconify-icon>
                                                                            </label>
                                                                        </li>
                                                            ...
                                                            <div class="strike-info QuestionTitle_wrap">
                                                                ...
                                                                <div class="insp_quest_ansChecklist">
                                                                    <ul class="checklist InspectionChecklistOpt">
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" name="checklist2" hidden="" disabled="" data-original-disabled="true">
                                                                               Yes
                                                                                <iconify-icon icon="gg:check-o" class="check-icon"></iconify-icon>
                                                                            </label>
                                                                        </li>
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" name="checklist2" hidden="" checked="" disabled="" data-original-disabled="true">
                                                                               No
                                                                                <iconify-icon icon="gg:check-o" class="check-icon"></iconify-icon>
                                                                            </label>
                                                                        </li>
                                                            ...
                                                            <div class="strike-info QuestionTitle_wrap">
                                                                ...
                                                                <div class="insp_quest_ansChecklist">
                                                                    <ul class="checklist InspectionChecklistOpt">
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" name="checklist3" hidden="" disabled="" data-original-disabled="true">
                                                                               Yes
                                                                                <iconify-icon icon="gg:check-o" class="check-icon"></iconify-icon>
                                                                            </label>
                                                                        </li>
                                                                        ...
                                                                        <li>
                                                                            <label>
                                                                                <input type="radio" name="checklist3" hidden="" checked="" disabled="" data-original-disabled="true">
                                                                               N/A
                                                                                <iconify-icon icon="gg:check-o" class="check-icon"></iconify-icon>
                                                                            </label>
                                                                        </li>
